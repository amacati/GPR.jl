...
function _experiment_fb_max(config, id; meandynamics = false)    
...
function experiment_fb_mz_max(config, id)
    return _experiment_fb_max(config, id, meandynamics=false)
end

function experiment_fb_md_max(config, id)
    return _experiment_fb_max(config, id, meandynamics=true)
end
